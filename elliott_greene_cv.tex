...
\vspace{6pt}
    ...
    \section*{Presentations}
        \begin{itemize}[leftmargin=.25in]
            ...
            \item Posters
                \begin{itemize}
                    \item June 2023, "{\it A model for the prion-mediated horizontal transfer of social behavior facilitating inter-kingdom cooperation in Saccharomyces cerevisiae}", Evolution 2023, Albuquerque, NM, USA
                    \item March 2023, "{\it A model for the evolution of gene regulatory networks governing social traits}", Midwest Ecology and Evolution Conference 2023, Louisville, KY, USA 
